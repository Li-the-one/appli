...
const server = http.createServer((req, res) => {
  if (req.method === 'GET' && (req.url === '/' || req.url === '/index.html')) {
    ...
    serveStatic(res, path.join(__dirname, '..', 'public', 'app.js'), 'text/javascript');
  } else if (req.method === 'GET' && req.url === '/styles.css') {
    serveStatic(res, path.join(__dirname, '..', 'public', 'styles.css'), 'text/css');
  } else if (req.method === 'GET' && req.url === '/moodboards') {
